...
import {translateRecordStatus,datetimeLocalToMysql, mysqlToDatetimeLocal, formatDateTime } from './utils.js';
...
function getSourceBadge(record) {
    const sources = {
        ...
        'user_token': { icon: '📱', label: 'User App', color: '#27ae60' },
        'device_token': { icon: '🖥️', label: 'Gerät', color: '#9b59b6' },
        'qr_verified': { icon: '📷', label: 'QR-Code', color: '#e67e22' },

...
require_once 'handlers/records.php';
require_once 'handlers/exceptions.php';
require_once 'handlers/users.php';
require_once 'handlers/membership_dates.php';
require_once 'handlers/device_config.php';
require_once 'handlers/auto_checkin.php';
require_once 'handlers/qr_verification.php';
require_once 'handlers/regenerate_token.php';
require_once 'handlers/change_password.php';
...
switch($resource) {
    ...
    case 'membership_dates':
        ...
        break;       
    case 'device_configs':
        handleDeviceConfigs($db, $request_method, $id);
        break;
    case 'auto_checkin':
    ...
    case 'checkin_verify':
        handleQRVerification($db, $request_method, $authUserId, $authUserRole, $authMemberId, $isTokenAuth);
        exit();
